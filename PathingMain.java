...
public class PathingMain extends PApplet
{
   ...
   private static enum GridValues { BACKGROUND, OBSTACLE, PLAYER, GOAL};
   ...
   private void draw_tile(int row, int col)
   {
      switch (grid[row][col])
      {
         ...
         case GOAL:
            ...
            break;
         case PLAYER:
            image(wyvern, col * TILE_SIZE, row * TILE_SIZE);
            break;
      }
   }
   ...
   public void mousePressed()
   {
      ...
      switch(tileSelect) {
         ...
         case 'O':
            ...
            break;
         case 'P':
            if (grid[pressed.y][pressed.x] == GridValues.PLAYER)
               grid[pressed.y][pressed.x] = GridValues.BACKGROUND;
            else if (grid[pressed.y][pressed.x] == GridValues.BACKGROUND)
               grid[pressed.y][pressed.x] = GridValues.PLAYER;
            break;
      }
      redraw();
